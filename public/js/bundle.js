...
exports.showAlert = exports.hideAllert = void 0;
var hideAllert = exports.hideAllert = function hideAllert() {
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51PGOfGC8symgJf5WXjjt6KazVEBs5tAa34t7O8PfMs6yneQsvzrwu9TBLAxtGo1PtMRzWtKXbl62dhfgoWAhJ58w008As7gTIF'); // 1) Get checkout session from endpoint API
          _context.next = 4;
          return (0, _axios.default)("http://127.0.0.1:3000/api/v1/bookings/checkout-session/".concat(tourId));
        case 4:
          response = _context.sent;
          session = response.data.session; // 2) Create checkout form + charge credit card
          _context.next = 8;
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /* eslint-disable */
// DOM ELEMENTS
var mapLeaflet = document.getElementById('map');
